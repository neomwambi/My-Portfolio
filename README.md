...
- **Contact form:** Uses [Formspree](https://formspree.io/). In `contact.html`, replace `YOUR_FORM_ID` in the form `action` URL with your Formspree form ID and follow the activation comment above the `<form>` tag.
